...
│  ├─ _lib/                             requireUser, requireOwnedDoc, rateLimit, sanitize, env
...
- Current tests: `shared/lib/env.test.ts`, `convex/_lib/rateLimit.test.ts`, `convex/_lib/sanitize.test.ts`
