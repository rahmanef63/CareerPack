    ...
    >
      ...
      {Array.from({ length: _values.length }, (_, index) => (
        <SliderPrimitive.Thumb
          ...
          key={index}
          // bg-background, not bg-white (upstream's value, lost at some point):
          // a literal white thumb stays white in dark mode and under every
          // preset, so on a dark track it reads as a rendering artefact.
