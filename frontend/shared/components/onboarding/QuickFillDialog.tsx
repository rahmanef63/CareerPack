      ...
      >
        ...
        {isDemo && (
          <div className="shrink-0 rounded-lg border-2 border-destructive bg-destructive/10 p-4 text-sm">
            ...
            {/* A button, not a <Link>: navigating while the demo session is
                still live lets the guest guard on /login bounce it straight to
                /dashboard, and the signOut that lands afterwards redirects to
                the landing page — so the one person who had decided to sign up
                never reaches a form. Same fix as DemoBanner's "Daftar". */}
            <Button
              size="sm"
              className="mt-3"
            ...
            >
              ...
              Daftar gratis untuk pakai Isi Cepat
            </Button>
          </div>
        )}
