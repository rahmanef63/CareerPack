  ...
  return (
    <div className="space-y-4 mt-2">
      ...
      <div className="flex flex-wrap justify-end gap-2">
        {/* Icon-only, so `title` has to carry the whole instruction the removed
            success toast used to: what it copies AND where to paste it. */}
        <CopyButton
          value={JSON.stringify(result, null, 2)}
          label="Salin debug log — paste di chat support"
          title="Salin debug log — paste di chat support"
          variant="outline"
        />
