  ...
  return (
    <div className="relative flex flex-col items-center">
      <button
        type="button"
        onClick={(e) => {
          // Blur before opening the AI console — otherwise focus stays
          // on this FAB while Radix applies aria-hidden to its parents,
          // tripping the "descendant retained focus" warning.
