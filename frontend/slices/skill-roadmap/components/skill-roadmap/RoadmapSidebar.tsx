        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between p-3 bg-success/10 rounded-lg">
              ...
              <span className="font-bold text-success-text">{totalHours}+</span>
            </div>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-1 mt-0.5">
                      ...
                      {resource.free && (
                        <Badge variant="secondary" className="text-[10px] h-4 px-1 bg-success/20 text-success-text">Gratis</Badge>
                      )}
                    </div>
                  </div>
