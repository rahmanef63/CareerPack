      ...
      <Card className="border-border">
        <CardHeader className="pb-3">
          <CardTitle className="text-base flex items-center gap-2">
            ...
            {/* Dropped an "engine seed" badge that sat here. It was the name of
                an admin-panel tab — internal vocabulary, in English, on a page a
                job seeker reads, telling them nothing about the templates they
                came for. Deleted rather than translated: there is no Indonesian
                phrasing of it that would earn its place either. */}
          </CardTitle>
        ...
        <CardContent className="space-y-3">
          {templates === undefined ? (
            ...
            <p className="rounded-md border border-dashed border-warning/50 bg-warning/5 p-3 text-xs text-warning-text">
