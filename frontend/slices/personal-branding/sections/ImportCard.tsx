      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          <ol className="list-decimal space-y-1 pl-5 text-xs text-muted-foreground">
            ...
            <li>Pilih <em>lingkup</em> &quot;Profil saja&quot; (default), salin prompt yang ditampilkan.</li>
            <li>Tempel ke AI bersama dengan teks CV / LinkedIn Anda.</li>
            <li>Salin balasan AI (JSON), tempel ke step terakhir, klik Kirim &amp; Import.</li>
          </ol>
          <QuickFillButton
            scope="profile"
            label="Mulai Quick Fill — lingkup Profil"
          />
        </CardContent>
      </Card>
    ...
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          ...
          ekstrak field profilnya. Lebih cepat dari jalur copy-paste,
          tapi saat ini hanya isi <strong>data profil</strong>.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-3">
        <Textarea
