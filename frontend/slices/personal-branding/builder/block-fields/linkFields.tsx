      ...
      <div className="space-y-1">
        ...
        >
          ...
          <ResponsiveSelectContent drawerTitle="Variasi tombol">
            <ResponsiveSelectItem value="primary">Warna penuh</ResponsiveSelectItem>
            <ResponsiveSelectItem value="secondary">Garis tipis</ResponsiveSelectItem>
            <ResponsiveSelectItem value="ghost">Garis putus-putus</ResponsiveSelectItem>
          </ResponsiveSelectContent>
        </ResponsiveSelect>
      </div>
    </div>
