...
export function TrustStripCell({ item }: TrustStripCellProps) {
  ...
  return (
    <div className="group flex items-center gap-3">
      <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-muted text-primary transition-transform duration-200 group-hover:scale-110">
