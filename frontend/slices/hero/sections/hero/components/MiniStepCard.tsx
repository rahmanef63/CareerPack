...
export function MiniStepCard({ step }: MiniStepCardProps) {
  ...
  return (
    <div className="relative z-10 flex flex-col items-start gap-3 bg-landing-paper">
      <span
        className={`flex h-12 w-12 items-center justify-center rounded-full text-white ${step.bgClassName}`}
      >
