...
import { NoNotifications } from "@/shared/components/illustrations/empty";
      ...
      >
        ...
        <TabsContent value={filter} className="mt-4 space-y-5">
          {isLoading ? (
            ...
            <EmptyState
              // ponytail: art only on the true-zero branch; unread/important are filter states.
              illustration={filter === "all" ? NoNotifications : undefined}
              icon={BellOff}
              title={
                filter === "unread"
              ...
              description="Pemberitahuan terkait progres karir akan muncul di sini."
              action={{
