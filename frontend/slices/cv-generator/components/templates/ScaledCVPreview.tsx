...
export const ScaledCVPreview = memo(
  ...
  function ScaledCVPreview(
    ...
    return (
      <div
        ref={outerRef}
        // bg-muted, not a fixed neutral pair: this is the app-side mat the
        // A4 page sits on (the page itself stays white for print), so it has
        // to follow the active preset — neutral-100/800 ignored all 36.
        className="flex justify-center bg-muted rounded-md px-2 py-4"
        style={{
