...
export const portfolioManifest: SliceManifest = {
  id: "portfolio",
  label: "Portofolio",
  description: "Showcase proyek + sertifikasi + publikasi",
  icon: Folder,

  skills: [
    {
      id: "portfolio.list",
      label: "Lihat daftar portofolio",
      description:
    ...
    },
    {
      ...
      cta: "Buat item",
      args: {
        title: { type: "string", label: "Judul proyek/sertifikat", required: true, example: "Sertifikasi AWS" },
