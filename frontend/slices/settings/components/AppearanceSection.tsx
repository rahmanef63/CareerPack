    ...
    <Card>
      ...
      <CardContent className="space-y-3">
        ...
        <p className="text-xs text-muted-foreground">
          ...
          <span translate="no">{formatCurrency(1500000)}</span>). Ini tidak
          mengubah teks.
        </p>
        {/* Content language is a separate control from number/date format on
            purpose — someone working abroad may want Rupiah with English copy,
            or the reverse. */}
        <div className="border-t border-border pt-3">
          <TranslatePicker label="Bahasa teks halaman" />
          <p className="mt-2 text-xs text-muted-foreground">
            Menerjemahkan seluruh isi aplikasi lewat Google Translate. Halaman
            dimuat ulang saat diganti.
          </p>
        </div>
      </CardContent>
    </Card>
