...
import { NoInterviews } from "@/shared/components/illustrations/empty";
    ...
    return (
      <Card className="border-border">
        <CardContent className="flex flex-col items-center gap-4 py-12 text-center">
          {/* ponytail: swaps the Play-icon circle — the CTA below already carries that glyph. */}
          <NoInterviews className="w-40 md:w-48" />
          ...
          <CardContent>
            ...
            {showAnswer && currentQuestion.sampleAnswer && (
              <div className="mt-6 p-4 bg-success/10 rounded-lg border border-success/30">
                <p className="font-medium text-success-text mb-2">Contoh Jawaban:</p>
