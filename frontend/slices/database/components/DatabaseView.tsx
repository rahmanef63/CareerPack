  ...
  return (
    <div className="mx-auto w-full max-w-7xl space-y-6 px-4 py-6">
      <header className="space-y-1.5">
        <h1 className="text-2xl font-bold tracking-tight">Data Saya</h1>
        <p className="text-sm text-muted-foreground">
          Tampilan tabel lintas-fitur untuk edit massal, ekspor, dan
          impor JSON. Halaman fitur (CV, Lamaran, Jaringan, Portofolio,
          dst.) tetap jadi tempat utama untuk membuat &amp; edit per
          item — halaman ini fokus pada operasi massal &amp; transfer data.
        </p>
      </header>
      ...
      <Tabs defaultValue="cv" className="space-y-4">
        <TabsList variant="pills">
          ...
          <TabsTrigger value="goals">Target Karir</TabsTrigger>
