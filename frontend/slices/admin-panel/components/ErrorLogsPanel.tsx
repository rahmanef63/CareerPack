                    ...
                    <td className="px-3 py-2 text-xs">
                      <details>
                        ...
                        <div className="mt-2 flex items-center gap-2">
                          {/* One button for the whole entry rather than one per
                              field — an operator pasting into a bug report wants
                              the stack with its source and route attached. */}
                          <CopyButton
                            value={[
                              `Source: ${l.source}`,
