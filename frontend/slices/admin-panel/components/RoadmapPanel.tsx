...
export function RoadmapPanel() {
  ...
  const handleSaveCareerPath = async () => {
    ...
    try {
      ...
      notify.success("Jalur karir diperbarui");
      setCareerPathEditing(false);
    } catch (err) {
      notify.fromError(err, "Gagal memperbarui jalur karir");
    } finally {
      setBusy(false);
    }
  };
    ...
    <>
      <Card>
        <CardHeader className="pb-3">
          ...
          <CardDescription>
            Lihat dan kelola roadmap skill setiap pengguna. Klik &quot;Kelola Skill&quot; untuk tambah,
        ...
        <CardContent>
          <DataTable<RoadmapRow>
            ...
            searchPlaceholder="Cari email atau jalur karir…"
        ...
        <ResponsiveAlertDialogContent>
          <ResponsiveAlertDialogHeader>
            ...
            <ResponsiveAlertDialogDescription>
              ...
              {deleteRoadmapConfirm?.userEmail || GUEST_LABEL} akan dihapus permanen.
              Tidak bisa di-undo.
            </ResponsiveAlertDialogDescription>
          </ResponsiveAlertDialogHeader>
