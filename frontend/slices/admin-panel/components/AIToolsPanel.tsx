...
export function AIToolsPanel() {
  ...
  const handleSeed = async () => {
    ...
    try {
      ...
      notify.fromError(err, "Gagal memuat default");
    } finally {
      setSeeding(false);
    }
  };
        ...
        <CardHeader className="flex-row items-start justify-between gap-3 space-y-0">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            >
              ...
              <span className="ml-2">Muat default</span>
            </Button>
        ...
        <CardContent>
          {tools === undefined ? (
            ...
            <div className="rounded-md border border-dashed border-border p-6 text-center text-sm text-muted-foreground">
              Belum ada tool. Klik <strong>Muat default</strong> untuk
              mengisi tool bawaan.
            </div>
          ) : (
      ...
      >
        <ResponsiveDialogContent size="lg">
          <ResponsiveDialogHeader>
            ...
            <ResponsiveDialogDescription>
              Tipe harus cocok dengan whitelist server. Tool baru tidak akan
            ...
            <div className="space-y-3">
              <div className="grid gap-3 sm:grid-cols-2">
                <div className="space-y-1">
                  <Label htmlFor="tl-type">Tipe (unik)</Label>
                  <Input
                    id="tl-type"
                    value={editing.type}
