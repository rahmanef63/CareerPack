      ...
      {expanded && (
        <div className="p-3 space-y-3 border-t">
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <div className="space-y-1">
              <Label className="text-xs">ID Induk</Label>
              <Select
          ...
          <div className="space-y-1">
            <Label className="text-xs">Prasyarat (ID dipisah koma)</Label>
            <Input
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <Label className="text-xs">Resource ({node.resources.length})</Label>
              <button
                type="button"
                onClick={() => onChange({
                  ...node,
