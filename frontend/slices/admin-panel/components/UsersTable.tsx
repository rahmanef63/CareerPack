...
import { GUEST_LABEL } from "../constants/guest";
  ...
  const columns: ReadonlyArray<ColumnDef<RowData>> = [
    {
      ...
      cell: (r) =>
        r.email ? (
          ...
          <span className="italic text-muted-foreground">{GUEST_LABEL}</span>
        ),
    },
    {
      id: "fullName",
    ...
    {
      // Separate column from "Lokasi" on purpose: that one is whatever the
      // user typed into their profile, this one is measured. Never merge or
      // cross-fill them.
      id: "ipCountry",
      header: "Negara (IP)",
      accessor: (r) => r.ipCountry || "",
      cell: (r) => r.ipCountry || "—",
      hideOnMobile: true,
    },
    {
  ...
  const filters: ReadonlyArray<FilterDef<RowData>> = [
    ...
    },
    {
      ...
      options: [
        ...
        { value: "anonymous", label: GUEST_LABEL },
      ],
    },
  ];
    ...
    <Card>
      <CardHeader className="pb-3">
        ...
        <CardDescription>
          ...
          aksi massal. Kolom &quot;Negara (IP)&quot; masih &quot;—&quot; di
          semua baris: pencatatannya belum diaktifkan, bukan berarti
          negaranya tidak diketahui.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <DataTable<RowData>
