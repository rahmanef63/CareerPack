    ...
    <div className="space-y-4">
      <Card>
        <CardHeader className="pb-2">
          ...
          <CardDescription>
            Muat (atau perbarui) data katalog yang dibutuhkan engine
            CareerPack. Idempoten — aman di-klik ulang setelah edit
            file seed di repo.
          </CardDescription>
        </CardHeader>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          {!stats ? (
            ...
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
              <StatTile
                label="Node Career Graph"
                value={stats.careerNodeCount}
                expected={stats.expected.careerNodes}
              />
              <StatTile label="Edge Career Graph" value={stats.careerEdgeCount} />
              <StatTile
      ...
      <Card>
        ...
        <CardContent className="space-y-2 text-xs text-muted-foreground">
          <p>
            <strong>Idempoten</strong> — aman dijalankan ulang. Patch hanya
            kalau isi seed berubah; hanya baris baru yang di-insert.
          </p>
          <p>
            <strong>File seed</strong> ada di repo:{" "}
            ...
            . Setelah edit + deploy, klik tombol di atas untuk menerapkan.
          </p>
          <p>
            <strong>Hapus permanen</strong> tidak pernah dilakukan oleh seed.
            Kalau seed dihapus dari repo, barisnya di DB tetap ada — bersihkan
