...
import { NoApplications } from "@/shared/components/illustrations/empty";
...
export function ApplicationKanban({
  ...
  if (applications.length === 0) {
    return (
      <EmptyState
        illustration={NoApplications}
        title="Belum ada lamaran"
        description="Tambah lamaran pertama Anda untuk mulai melacak progres."
        action={onAdd ? { label: "Tambah Lamaran", onClick: onAdd, icon: Plus } : undefined}
        size="lg"
