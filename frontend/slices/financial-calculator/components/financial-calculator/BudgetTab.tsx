          ...
          <CardHeader className="space-y-3">
            <div className="flex items-start justify-between gap-3">
              ...
              <Tabs
                ...
                className="w-auto"
              >
                {/* No bespoke h-/w- here: `h-8` undercut TabsList's own
                    `h-11 sm:h-9` (WCAG 2.5.5 mobile target), and the fixed
                    180px could not shrink, so at 390px the pair overflowed
                    the card's right edge past "Pendapatan". */}
                  ...
                  <div key={v._id}>
                    <div className="flex justify-between items-center mb-2 gap-2">
                      <div className="flex items-center gap-2 min-w-0">
                        ...
                        {v.kind === "savings" && (
                          <Badge variant="secondary" className="bg-success/15 text-success-text text-[10px]">
                            Tabungan
                          </Badge>
                        )}
                      </div>
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <div className={cn(
                ...
                <p className={cn(
                  "text-sm",
                  unallocated >= 0 ? "text-info-text" : "text-warning",
                )}>
              ...
              <div className="pt-4 border-t border-border">
                <div className="flex justify-between items-center">
                  ...
                  <span className={cn(
                    "font-bold",
                    savingsRate >= 20 ? "text-success-text" : "text-warning",
                  )}>
