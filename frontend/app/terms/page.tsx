...
export default function TermsPage() {
  return (
    ...
    <main className="mx-auto max-w-3xl px-4 py-12 prose prose-sm dark:prose-invert">
      ...
      <p>
        Dokumen ini adalah versi kerja dan belum ditinjau penasihat hukum.
      </p>
      ...
      <h2>Kontak</h2>
      {/* mailto, not /dashboard/help — that page is behind the auth guard, so
          the old link sent anyone without an account into a login wall. */}
      <p>
        Pertanyaan:{" "}
