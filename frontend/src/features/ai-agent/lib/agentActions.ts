...
export type AgentAction =
  ...
  | {
      type: "cv.addSkills";
      payload: { skills: Array<{ name: string; category: "technical" | "soft" | "language" | "tool" }> };
    }
  | {
      type: "cv.setFormat";
...
export const ACTION_META: Record<AgentActionType, AgentActionMeta> = {
  "cv.fillExperience": {
  ...
  "cv.improveSummary": {
    ...
    description: "AI menulis ulang ringkasan agar lebih impactful.",
    cta: "Gunakan",
  },
  "cv.addSkills": {
  ...
  "interview.startSession": {
    ...
    description: "AI akan memulai sesi mock interview interaktif.",
    cta: "Mulai",
  },
  "match.recommend": {
