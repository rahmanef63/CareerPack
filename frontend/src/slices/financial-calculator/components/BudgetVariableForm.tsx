...
export function BudgetVariableForm({ existing, trigger }: BudgetVariableFormProps) {
  ...
  const create = useMutation(api.budgetVariables.createVariable);
  const update = useMutation(api.budgetVariables.updateVariable);
  const remove = useMutation(api.budgetVariables.removeVariable);
