...
export function AdminDashboard() {
  ...
  const stats = useQuery(api.admin.queries.getGlobalStats);
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm text-muted-foreground">Kelola sistem CareerPack</p>
              </div>
            </div>
