import type { AuthUser as User, ChatSession } from '@/shared/types';
import type { CVData } from '@/slices/cv-generator/types';
import type { Application } from '@/slices/career-dashboard/types';
import type { ChecklistItem } from '@/slices/document-checklist/types';
import type { InterviewSession } from '@/slices/mock-interview/types';
