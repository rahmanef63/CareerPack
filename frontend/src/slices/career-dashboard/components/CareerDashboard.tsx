...
function ApplicationRow({ app, onStatusChange, onDelete }: ApplicationRowProps) {
  // Fallback meta when an unexpected status string lands in the table
  // (e.g., from a stale seed). Without this the dashboard threw
  // "Cannot read properties of undefined (reading 'className')" and
  // the ErrorBoundary collapsed the whole list.
