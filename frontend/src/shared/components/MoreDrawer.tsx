...
const TILES: Tile[] = [
  ...
  { id: "interview", label: "Interview Prep", icon: MessageSquare, hue: "from-pink-400 to-pink-600" },
  { id: "matcher", label: "Job Matcher", icon: Compass, hue: "from-cyan-400 to-cyan-600", badge: "AI" },
  { id: "networking", label: "Networking", icon: Users, hue: "from-rose-400 to-rose-600" },
  { id: "portfolio", label: "Portfolio", icon: Folder, hue: "from-orange-400 to-orange-600" },
  { id: "notifications", label: "Notifikasi", icon: Bell, hue: "from-yellow-400 to-yellow-600" },
  { id: "settings", label: "Profil & Setting", icon: SettingsIcon, hue: "from-slate-500 to-slate-700" },
