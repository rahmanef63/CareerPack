  	...
  	extend: {
  		colors: {
  			...
  			destructive: {
  				...
  				// Same split as warning/success/info: DEFAULT is the fill tone
  				// and measures 3.72:1 as text, `text` is the prose tone.
  				text: 'oklch(var(--destructive-text) / <alpha-value>)'
  			},
  			success: {
  				DEFAULT: 'oklch(var(--success) / <alpha-value>)',
  				foreground: 'oklch(var(--success-foreground) / <alpha-value>)',
  				// Same split as `warning` below, added when tokenising label
  				// colours dropped them under WCAG AA: DEFAULT is the fill tone
  				// and measures 2.49:1 as text, `text` is the prose tone.
